...
#SBATCH --time=25:00:00 ## how long does this need to run (remember different partitions have restrictions on this param)
...
python -u /home/yyr4332/project/EEG_analysis/hmm_cv.py ${hmm_n} ${iter} ${seed} ${fold}
