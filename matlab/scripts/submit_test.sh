...
#SBATCH --job-name=preprocess  ## When you run squeue -u NETID this is how you can identify the job
...
matlab -nosplash -nodesktop -singleCompThread -r yy_auto_process_test
